# Operator Quickstart — Construction of Other Civil Engineering Projects

Shortest path from clone to a verified local dry-run for **ISIC 4290** (`cloud-itonami-isic-4290`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4290.git
cd cloud-itonami-isic-4290
```
...
- Blueprint governor key: `civilworks-governor`
- Likely source path: `civilworks.governor.cljc`
