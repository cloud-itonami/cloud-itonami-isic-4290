# Business Model: Construction of Other Civil Engineering Projects
...
## Classification
- Repository: `cloud-itonami-isic-4290` ([github.com/cloud-itonami/cloud-itonami-isic-4290](https://github.com/cloud-itonami/cloud-itonami-isic-4290))
- ISIC Rev.5: `4290` — Construction of Other Civil Engineering Projects
- Domain: `:construction/other-civil-engineering`
- Social impact: :worker-safety :buried-utility-strike-prevention :excavation-collapse-prevention
- Actor: `:civilworks-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :construction/other-civil-engineering — who wants
...
One managed tenant (:construction/other-civil-engineering):
...
- Do not bypass the `:civilworks-governor` for production decisions.
